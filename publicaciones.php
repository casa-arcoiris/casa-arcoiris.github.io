...
<head>
	...
	<meta charset="UTF-8">
	<meta name="description" content="Casa Arcoíris es un blog con el objetivo de ayudar a jóvenes que forman parte de la comunidad LGBTQ+. Aquí puedes encontrar todas nuestras publicaciones.">
	<meta name="keywords" content="casa, arcoíris, comunidad, lgbtq, casa arcoíris, comunidad lgbtq, publicaciones, artículos, posts, publicaciones casa arcoíris">
	<meta name="viewport" content="width=device-width, initial-scale=1.0">
	<title>Publicaciones | Casa Arcoíris</title>
...
<body>
	...
	<h1 class="div_text">Publicaciones</h1>
	...
	<div class="centered_content post-container" id="filteredList">
		...
		<div class="post-card_container draw">
			...
			<p class="post_description">¿Alguna vez has experimentado ansiedad? ¿Sabes lo que es? ¿Sabes cómo se siente? ¡Aquí te decimos todo lo que necesitas saber!</p>
		...
		<div class="post-card_container draw">
			<a href="https://www.casa-arcoiris.org/publicaciones/lgbtq/pansexualidad.php" class="post-card pansexual lgbtq">
				<p>Pansexualidad</p>
			</a>
			<a href="https://www.casa-arcoiris.org/publicaciones/lgbtq/arromanticismo.php" class="go_to_post-btn">Ver publicación</a>
			<p class="post_description">Seguramente has escuchado la palabra "pansexual", pero ¿Qué significa? ¿Es lo mismo que la bisexualidad? ¿Es una confusión?</p>
			<div class="categorias_post categorias_post-cards">
				<div class="categoria_post lgbtq categoria_post-card">LGBTQ+</div>
				<div class="categoria_post pansexual categoria_post-card">Pansexualidad</div>
			</div>
			<div class="published card">
				<svg class="clock_icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path d="M256 8C119 8 8 119 8 256s111 248 248 248 248-111 248-248S393 8 256 8zm0 448c-110.5 0-200-89.5-200-200S145.5 56 256 56s200 89.5 200 200-89.5 200-200 200zm61.8-104.4l-84.9-61.7c-3.1-2.3-4.9-5.9-4.9-9.7V116c0-6.6 5.4-12 12-12h32c6.6 0 12 5.4 12 12v141.7l66.8 48.6c5.4 3.9 6.5 11.4 2.6 16.8L334.6 349c-3.9 5.3-11.4 6.5-16.8 2.6z"/></svg>
				<p>30/09/2022</p>
		...
		<div class="post-card_container draw">
			<a href="https://www.casa-arcoiris.org/publicaciones/lgbtq/gay.php" class="post-card gay lgbtq">
				<p>¿Gay?</p>
			</a>
			<a href="https://www.casa-arcoiris.org/publicaciones/lgbtq/gay.php" class="go_to_post-btn">Ver publicación</a>
		...
		<div class="post-card_container draw">
			...
			<p class="post_description">¿Alguna vez has visto muchas banderas de colores de la comunidad LGBTQ+ pero no sabes de qué sigla son? ¡Aquí te decimos!</p>
			<div class="categorias_post categorias_post-cards">
				<div class="categoria_post lgbtq categoria_post-card">LGBTQ+</div>
			</div>
			<div class="published card">
		...
		<div class="post-card_container draw">
			...
			<p class="post_description">Puede que hayas oído a alguien decir "¡Sal del clóset!", pero ¿Qué es eso? ¿Cómo se sale? ¿Qué debes considerar antes de hacerlo? ¡Aquí te lo explicamos!</p>
			<div class="categorias_post categorias_post-cards">
				<div class="categoria_post lgbtq categoria_post-card">LGBTQ+</div>
			</div>
			<div class="published card">
		...
		<div class="post-card_container draw">
			<a href="https://www.casa-arcoiris.org/publicaciones/lgbtq/bisexualidad.php" class="post-card bisexual lgbtq">
				<p>Bisexualidad</p>
			</a>
			<a href="https://www.casa-arcoiris.org/publicaciones/lgbtq/bisexualidad.php" class="go_to_post-btn">Ver publicación</a>
			<p class="post_description">¿Alguna vez haz escuchado la palabra "bisexualidad" o que alguien sale del clóset como "bisexual" pero no sabes qué significa? ¡Aquí te explicamos lo que es!</p>
			<div class="categorias_post categorias_post-cards">
				<div class="categoria_post lgbtq categoria_post-card">LGBTQ+</div>
				<div class="categoria_post bisexual categoria_post-card">Bisexual</div>
			</div>
			<div class="published card">
				<svg class="clock_icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path d="M256 8C119 8 8 119 8 256s111 248 248 248 248-111 248-248S393 8 256 8zm0 448c-110.5 0-200-89.5-200-200S145.5 56 256 56s200 89.5 200 200-89.5 200-200 200zm61.8-104.4l-84.9-61.7c-3.1-2.3-4.9-5.9-4.9-9.7V116c0-6.6 5.4-12 12-12h32c6.6 0 12 5.4 12 12v141.7l66.8 48.6c5.4 3.9 6.5 11.4 2.6 16.8L334.6 349c-3.9 5.3-11.4 6.5-16.8 2.6z"/></svg>
				<p>30/06/2022</p>
		...
		<div class="post-card_container draw">
			...
			<div class="categorias_post categorias_post-cards">
				<div class="categoria_post lgbtq categoria_post-card">LGBTQ+</div>
				<div class="categoria_post trans lgbtq categoria_post-card">Trans</div>
			</div>
			<div class="published card">
				<svg class="clock_icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path d="M256 8C119 8 8 119 8 256s111 248 248 248 248-111 248-248S393 8 256 8zm0 448c-110.5 0-200-89.5-200-200S145.5 56 256 56s200 89.5 200 200-89.5 200-200 200zm61.8-104.4l-84.9-61.7c-3.1-2.3-4.9-5.9-4.9-9.7V116c0-6.6 5.4-12 12-12h32c6.6 0 12 5.4 12 12v141.7l66.8 48.6c5.4 3.9 6.5 11.4 2.6 16.8L334.6 349c-3.9 5.3-11.4 6.5-16.8 2.6z"/></svg>
				<p>22/06/2022</p>
		...
		<div class="post-card_container draw">
			<a href="https://www.casa-arcoiris.org/publicaciones/jovenes/emocionario.html" class="post-card jovenes">
				<p>Emocionario</p>
			</a>
			<a href="https://www.casa-arcoiris.org/publicaciones/jovenes/emocionario.html" class="go_to_post-btn">Ver publicación</a>
			<p class="post_description">Todos tenemos emociones y, a veces, no sabemos cómo nos sentimos. Aquí te enseñamos 44 emociones para que las puedas identificar más fácilmente.</p>
			<div class="categorias_post categorias_post-cards">
				<div class="categoria_post jovenes categoria_post-card">Jóvenes</div>
			</div>
			<div class="published card">
		...
		<div class="post-card_container draw">
			<a href="https://www.casa-arcoiris.org/publicaciones/lgbtq/las_siglas.html" class="post-card lgbtq">
				<p>Las siglas</p>
			</a>
			<a href="https://www.casa-arcoiris.org/publicaciones/lgbtq/las_siglas.html" class="go_to_post-btn">Ver publicación</a>
			<p class="post_description">Como te podrás haber dado cuenta, la comunidad LGBTQ+ tiene varias siglas, pero ¿Qué significan? Aquí te explicamos algunas de las muchas siglas que existen.</p>
			<div class="categorias_post categorias_post-cards">
				<div class="categoria_post lgbtq categoria_post-card">LGBTQ+</div>
			</div>
			<div class="published card">
